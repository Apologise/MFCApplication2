...
BEGIN_MESSAGE_MAP(CMFCApplication2App, CWinAppEx)
	...
	ON_COMMAND(ID_FILE_NEW_FRAME, &CMFCApplication2App::OnFileNewFrame)
END_MESSAGE_MAP()
...
BOOL CMFCApplication2App::InitInstance()
{
	...
	m_hMDIMenu  = ::LoadMenu(hInst, MAKEINTRESOURCE(IDR_MFCApplication2TYPE));
	m_hMDIAccel = ::LoadAccelerators(hInst, MAKEINTRESOURCE(IDR_MFCApplication2TYPE));
...
void CMFCApplication2App::OnFileNewFrame() 
{
	CMainFrame* pFrame = new CMainFrame;
